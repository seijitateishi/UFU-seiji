...
<body>
  <header>
    <div class="header-content">
      ...
      <nav>
        <ul>
          <li><a href="../restricted/principal_interna.html">Início</a></li>
          <li><a href="../restricted/criar_anuncio.html" class="active">Criar Anúncio</a></li>
          <li><a href="../restricted/listar_anuncios.html">Meus Anúncios</a></li>
  ...
  <main>
    <section class="form-section">
      ...
      <form action="controladorRestrito.php?acao=criarAnuncio" method="POST" enctype="multipart/form-data">
